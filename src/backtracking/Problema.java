...
public interface Problema<P, S> {
    ...
    default  void risolvi() throws Exception {
        risolvi(Integer.MAX_VALUE);
    }

    default void risolvi(int num_max_soluzioni) throws Exception{ // template method
        int nr_soluzione = 0;
        ...
        if(nr_soluzione==0) System.out.println("NESSUNA SOLUZIONE");
